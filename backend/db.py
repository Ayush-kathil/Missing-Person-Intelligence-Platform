...
def init_db():
    ...
    try:
        ...
        logger.bind(event="db_init_error", error=str(e)).error("Failed to initialize database")
...
def get_session(session_id: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        logger.bind(event="db_get_error", error=str(e)).error(f"Failed to get session {session_id}")
        return None
...
def set_session(session_id: str, data: Dict[str, Any]) -> None:
    ...
    try:
        ...
        logger.bind(event="db_set_error", error=str(e)).error(f"Failed to set session {session_id}")
...
def delete_session(session_id: str) -> None:
    ...
    try:
        ...
        logger.bind(event="db_delete_error", error=str(e)).error(f"Failed to delete session {session_id}")
...
def flush_all_sessions() -> None:
    ...
    try:
        ...
        logger.bind(event="db_flush_error", error=str(e)).error("Failed to flush all sessions")
